...
-- Compact version with mobile/PC drag support
local DripUI = {}
...
function DripUI:Window(config)
    ...
    -- SMALLER UI SIZE
    local windowWidth = config.Width or 280
    local windowHeight = config.Height or 320
        ...
        for i, tab in ipairs(self.Tabs) do
            ...
            if tab.Button and tab.Button.Parent then
                if i == index then
                    ...
                    tab.Button.BackgroundColor3 = DripTheme.TabActive
                else
    ...
    function self:Tab(name)
        ...
        Button.MouseEnter:Connect(function()
            if self.SelectedTab ~= tabIndex and Button.Parent then
                tween(Button, 0.15, { BackgroundTransparency = 0 })
                Button.BackgroundColor3 = DripTheme.TabHover
            end
        end)
        ...
        function tab:Toggle(cfg)
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                tween(toggleKnob, 0.2, { Position = toggleState and UDim2.new(1, -16, 0.5, -7) or UDim2.new(0, 2, 0.5, -7) })
        ...
        function tab:Dropdown(cfg)
            ...
            local dropBtn = create("TextButton", {
                ...
                Position = UDim2.new(0.35, 5, 0.5, -11),
            ...
            local optionsFrame = create("Frame", {
                ...
                Position = UDim2.new(0.35, 5, 0, 26),
                BackgroundColor3 = DripTheme.DropdownBg,
                BorderSizePixel = 0,
                ClipsDescendants = true,
                Visible = false,
            ...
            dropBtn.MouseButton1Click:Connect(function()
                ...
                if isOpen then
                    ...
                    local height = math.min(optionCount * 22 + 4, 100)
