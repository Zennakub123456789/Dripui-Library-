...
function BrMods:Window(options)
    ...
    local openIconId = options.OpenIcon or "rbxassetid://12543323067" 
    ...
    function self:Tab(name)
        ...
        function tabObject:Toggle(config)
            ...
            ToggleBorder.BackgroundColor3 = Colors.Cyan 
