...
function DripUI:Window(config)
    ...
    local windowWidth = config.Width or 300
    local windowHeight = config.Height or 280
    local titleBarHeight = 26
    local tabBarHeight = 26
    ...
    function self:Tab(name)
        ...
        function tab:Toggle(cfg)
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                tween(toggleKnob, 0.2, { Position = toggleState and UDim2.new(1, -14, 0.5, -6) or UDim2.new(0, 2, 0.5, -6) })
        ...
        function tab:Dropdown(cfg)
            ...
            local dropBtn = create("TextButton", {
                ...
                Position = UDim2.new(0.35, 5, 0.5, -10),
            ...
            local optionsFrame = create("Frame", {
                ...
                Position = UDim2.new(0.35, 5, 0, 24),
                BackgroundColor3 = DripTheme.DropdownBg,
                BorderSizePixel = 0,
                ClipsDescendants = true,
                Visible = false,
            ...
            dropBtn.MouseButton1Click:Connect(function()
                ...
                if isOpen then
                    ...
                    local height = math.min(optionCount * 20 + 4, 90)
